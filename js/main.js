(function($){
	...
	var Home = {
		...
		GetWorkDedailDefault: function()
        {
        	...
        	$(".workdetailed .list, .workmain .list").find('li').eq(3).addClass("active");
		    $(".workdetailed .list").find('li').css('font-size', '3vmin');
		    $(".workdetailed .list").find('li').eq(3).css('font-size', '4vmin');
		    $(".workmain .list").find('li').css('font-size', '2vmin');
		    $(".workmain .list").find('li').eq(3).css('font-size', '2.3vmin');
		    $(".workdetailed .list, .workmain .list").find('li').eq(2).css('color', '#fffc');
		    $(".workdetailed .list, .workmain .list").find('li').eq(4).css('color', '#fffc');
		    $(".workdetailed .list, .workmain .list").find('li').eq(1).css('color', '#fff9');
		    $(".workdetailed .list, .workmain .list").find('li').eq(5).css('color', '#fff9');
		    $(".workdetailed .list, .workmain .list").find('li').eq(0).css('color', '#ffffff4d');
		    $(".workdetailed .list, .workmain .list").find('li').eq(6).css('color', '#ffffff4d');

		    $(".workdetailed .listimg, .workmain .listimg").find("div").css("opacity", '0');
		    $(".workdetailed .listimg, .workmain .listimg").find("div").eq(3).css("opacity", '1');
		},
		GetWorkDedail: function(type)
        {
        	...
        	if (textlength < 3)
		    {
		    	$(".workdetailed .list, .workmain .list").find('li').eq(0).addClass("active");
			    $(".workdetailed .list").find('li').css('font-size', '3vmin');
			    $(".workdetailed .list").find('li').eq(0).css('font-size', '4vmin');
			    $(".workmain .list").find('li').css('font-size', '2vmin');
		    	$(".workmain .list").find('li').eq(0).css('font-size', '2.3vmin');
			    $(".workdetailed .list, .workmain .list").find('li').eq(0).css('color', '#fff');
			    $(".workdetailed .list, .workmain .list").find('li').eq(1).css('color', '#fffc');

			    $(".workdetailed .listimg, .workmain .listimg").find("div").css("opacity", '0');
			    $(".workdetailed .listimg, .workmain .listimg").find("div").eq(0).css("opacity", '1');
		    }
		    else
		    {
		    	// $(".workdetailed .list").find('li').eq(3).addClass("active");
			    ...
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1).addClass("active");
			    $(".workdetailed .list").find('li').css('font-size', '3vmin');
			    $(".workdetailed .list").find('li').eq(numItems1).css('font-size', '4vmin');
			    $(".workmain .list").find('li').css('font-size', '2vmin');
		    	$(".workmain .list").find('li').eq(numItems1).css('font-size', '2.3vmin');
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1-1).css('color', '#fffc');
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1+1).css('color', '#fffc');
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1-2).css('color', '#fff9');
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1+2).css('color', '#fff9');
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1-3).css('color', '#ffffff4d');
			    $(".workdetailed .list, .workmain .list").find('li').eq(numItems1+3).css('color', '#ffffff4d');

			    $(".workdetailed .listimg, .workmain .listimg").find("div").css("opacity", '0');
			    $(".workdetailed .listimg, .workmain .listimg").find("div").eq(numItems1).css("opacity", '1');
		    }
